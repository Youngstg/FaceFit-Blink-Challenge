...
\begin{enumerate}
    ...
    \item \textbf{Kalibrasi EAR dinamis meningkatkan adaptabilitas sistem.} \\
 
    \item \textbf{Tracking objek terpasang mengikuti pergerakan wajah dengan presisi.} \\
 
    \item \textbf{Masking warna kulit menghasilkan tampilan natural.} \\
 
    \item \textbf{Arsitektur modular memudahkan pengembangan lanjutan.} \\
  
    \item \textbf{Caching asset meningkatkan performa loading.} \\
